...
/**
 * Kafka consumer wiring for the booking-slot Saga. Manual-ack so a message is only committed after the
 * slot mutation + idempotency row commit. On failure: retry 2s → 4s → 8s (3 attempts) then route to
