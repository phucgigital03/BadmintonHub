 ...
 *
 * <p>Applies to HTTP requests only (REST {@code /api/chat/**}). The WebSocket handshake ({@code /ws/**})
 * is public here; STOMP frames are authenticated separately at the CONNECT frame (PHASE 3, §G.1).</p>
 *
