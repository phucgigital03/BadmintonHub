...
/**
 * Transactional Outbox row. Written in the <b>same {@code @Transactional}</b> as the booking change it
 * describes, so the event is never lost and never published for a rolled-back booking. The
