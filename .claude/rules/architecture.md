...
docker-compose includes: PostgreSQL 15 ×9 · Redis 7 · MongoDB 7 ×2 (`mongodb` notification_db :27017 · `mongodb-chat` chat_db :27018) · Kafka 3.6 · Zookeeper · RabbitMQ 3 (STOMP relay cho chat-service · plugin `rabbitmq_stomp` :61613 · UI :15672) · Zipkin · Eureka
