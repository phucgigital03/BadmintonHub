...
| **Week 4** | event-service + integration | event-service + ai stub + smoke test toàn hệ thống (frontend đã gộp vào Day 4) |
...
Week 4: Day 20 (event-service + ai stub + smoke test) — frontend đã gộp vào Day 4
         (Day 16–19 để trống)
```
