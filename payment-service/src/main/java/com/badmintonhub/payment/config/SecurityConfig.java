...
import com.badmintonhub.payment.security.JwtAuthFilter;
 ...
 *
 * <p>Payment endpoints are all user-private (no public GET browse) — only actuator health/info is
 * public; everything else requires an authenticated principal.</p>
 */
@Configuration
@EnableWebSecurity
