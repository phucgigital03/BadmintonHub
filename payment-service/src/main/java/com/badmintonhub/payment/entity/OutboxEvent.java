...
/**
 * Transactional Outbox row. Written in the <b>same {@code @Transactional}</b> as the payment change it
 * describes, so the event is never lost and never published for a rolled-back payment. The
