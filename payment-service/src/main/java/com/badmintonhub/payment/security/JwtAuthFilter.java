package com.badmintonhub.payment.security;
 ...
 * {@code @PreAuthorize("hasAnyRole('USER','COACH') and hasAuthority('EMAIL_VERIFIED')")} — no call to user-service.</p>
 *
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    /** Synthetic authority marking a verified email — enforced by @PreAuthorize for payment initiation. */
